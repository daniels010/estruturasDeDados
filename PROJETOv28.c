...
typedef char String50[50], String12[12];

typedef struct{
    String50 nome;
    String12 cpf, contato;
    float divida;
    float val_parc;
    int num_parcelas;
}cliente;
...
long int tamALOC = 73*sizeof(char) + 2*sizeof(float) + sizeof(int);
